...
function retornaCorDeFundo(props: TagProps): string {
  if ('status' in props) {
    ...
    if (props.prioridade === 'importante') return variaveis.amareloZ
    if (props.prioridade === 'media') return variaveis.amareloZ
    if (props.prioridade === 'baixa') return variaveis.verde
  }
